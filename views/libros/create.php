                    ...
                    <form method="POST" action="index.php?page=libros&action=process-create">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="titulo" name="titulo" class="form-control" required minlength="3">
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="autor_id" name="autor_id" class="form-select" required>
                                    ...
                                    <?php foreach ($autores as $autor): ?>
                                        <option value="<?= $autor['id'] ?>"><?= Security::escape($autor['nombre']) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="categoria_id" name="categoria_id" class="form-select" required>
                                    ...
                                    <?php foreach ($categorias as $categoria): ?>
                                        <option value="<?= $categoria['id'] ?>"><?= Security::escape($categoria['nombre']) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
